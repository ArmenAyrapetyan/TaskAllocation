<div>
    <div class="form-floating mb-3">
        <input wire:model="contact_data.first_name" name="contact_data.first_name" type="text"
               ...
               @error('contact_data.first_name') is-invalid @enderror"
               id="floatingInput">
    ...
    <div class="form-floating mb-3">
        <input wire:model="contact_data.last_name" name="contact_data.last_name" type="text"
               ...
               @error('contact_data.last_name') is-invalid @enderror"
               id="floatingInput">
    ...
    <div class="form-floating mb-3">
        <input wire:model="contact_data.post" name="contact_data.post" type="text"
               ...
               @error('contact_data.post') is-invalid @enderror"
               id="floatingInput">
    ...
    <div class="form-floating mb-3">
        <select wire:model="contact_data.source_id" name="contact_data.source_id"
                class="form-control @isset($contact_data['source_id']) is-valid @endisset
                @error('contact_data.source_id') is-invalid @enderror">
    ...
    <div class="form-floating mb-3">
        <select wire:model="contact_data.special_group_id" name="contact_data.special_group_id"
                class="form-control @isset($contact_data['special_group_id']) is-valid @endisset
    ...
    <div class="form-floating mb-3">
        <input wire:model="contact_data.phone" name="contact_data.phone" type="text"
               ...
               @error('contact_data.phone') is-invalid @enderror"
               id="floatingInput">
    ...
    <div class="form-floating mb-3">
        <input wire:model="contact_data.email" name="contact_data.email" type="email"
               ...
               @error('contact_data.email') is-invalid @enderror"
               id="floatingInput">
    ...
    <div class="form-floating mb-3">
        <input wire:model="contact_data.telegram" name="contact_data.telegram" type="text" value="@"
               class="form-control @isset($contact_data['telegram']) @if($contact_data['telegram'] != '') is-valid @else is-invalid @endif @endisset
               @error('contact_data.telegram') is-invalid @enderror"
               id="floatingInput">
    ...
    <div class="form-floating mb-3">
        <input wire:model="contact_data.vk_url" name="contact_data.vk_url" type="text"
               ...
               @error('contact_data.vk_url') is-invalid @enderror"
               id="floatingInput">
