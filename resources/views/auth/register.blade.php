            ...
            <div class="card m-2">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="third_name" class="col-md-4 col-form-label text-md-end">{{ __('Отчество') }}</label>

                            <div class="col-md-6">
                                <input id="third_name" type="text" class="form-control @error('third_name') is-invalid @enderror" name="third_name" value="{{ old('third_name') }}" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="register_token" class="col-md-4 col-form-label text-md-end">{{ __('Ваш токен регистрации') }}</label>

                            <div class="col-md-6">
                                <input id="register_token" type="text" class="form-control @error('register_token') is-invalid @enderror" name="register_token" value="{{ old('register_token') }}" autofocus>
